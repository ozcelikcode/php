...
require_once 'inc/ust.php'; ?>
        ...
        WHERE yazi_durum=:d AND yazi_sef_etiketler REGEXP :baslik");
                ...
                <div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
                    ...
                    <?php
                        ...
                        $sorgu  = $db->prepare("SELECT * FROM yazilar
                          INNER JOIN kategoriler ON kategoriler.id = yazilar.yazi_kat_id 
                          WHERE yazi_durum=:d AND yazi_sef_etiketler REGEXP :baslik ORDER BY yazi_tarih DESC LIMIT :goster,:lim
                        ");
