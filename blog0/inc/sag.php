...
<div class="sidebar sticky-sidebar col-lg-3">
                            ...
                            if($populer->rowCount()){
                                foreach ($populer as $item) {
                                    ...
                                    <div class="post-thumbnail-entry">
                                        <img alt="<?php echo $item['yazi_baslik'];?>" src="<?php echo $arow->site_url;?>/images/<?php echo $item['yazi_resim'];?>">
                                        <div class="post-thumbnail-content">
                                            <a href="<?php echo $arow->site_url;?>/yazidetay.php?yazi_sef=<?php echo $item['yazi_sef'];?>&id=<?php echo $item['yazi_id'];?>"><?php echo $item['yazi_baslik'];?> (<?php echo $item['yazi_goruntulenme'];?>)</a>
    ...
    <div class="widget  widget-tags">
        <h4 class="widget-title">ETİKET BULUTU</h4>
        <div class="tags">
