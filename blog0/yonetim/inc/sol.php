...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview <?php if(loc() == $yonetim."/okunmusmesajlar.php" || loc() == $yonetim."/bekleyenmesajlar.php" || loc() == $yonetim."/islemler.php?islem=mesajoku&id=".get('id')){ echo "is-expanded"; } ?>"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-envelope"></i><span class="app-menu__label">Mesajlar</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="<?php echo $yonetim;?>/bekleyenmesajlar.php"><i class="icon fa fa-circle-o"></i> Yeni Mesajlar ( <?php echo say('mesajlar','durum',2 ) ;?> )</a></li>
        ...
        <li class="treeview <?php if(loc() == $yonetim."/aboneler.php") { echo "is-expanded"; } ?>"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Aboneler</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
