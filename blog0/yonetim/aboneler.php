...
<?php require_once 'inc/sol.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Abone Listesi</h1>
          <p>Abone Listesi</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Abone Listesi</li>
        ...
        <div class="col-md-12">
          <div class="tile">
            <?php
                ...
                $sorgu = $db->prepare("SELECT * FROM aboneler 
            ...
            <h3 class="tile-title">Abone Listesi ( <?php echo $toplam;?> )</h3>
