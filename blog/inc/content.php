        ...
        <div class="container">
            <div class="item mb-5">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="title mb-1"><a href="<?php echo $page_link; ?>">Why Every Developer Should Have A Blog</a></h3>
                        ...
                        <a class="more-link" href="<?php echo $page_link; ?>">Read more &rarr;</a>
                    </div>
                    <!--//media-body-->
                </div>
                <!--//media-->
            ...
            <div class="item mb-5">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="title mb-1"><a href="<?php echo $page_link; ?>">A Guide to Becoming a Full-Stack Developer</a></h3>
            ...
            <div class="item mb-5">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="title mb-1"><a href="<?php echo $page_link; ?>">High Performance JavaScript</a></h3>
            ...
            <div class="item mb-5">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="title mb-1"><a href="<?php echo $page_link; ?>">Top 5 JavaScript Frameworks</a></h3>
            ...
            <div class="item mb-5">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="title mb-1"><a href="<?php echo $page_link; ?>">Learn React in 24 Hours</a></h3>
            ...
            <div class="item">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="title mb-1"><a href="<?php echo $page_link; ?>">About Remote Working</a></h3>
