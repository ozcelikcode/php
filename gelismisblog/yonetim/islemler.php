                      ...
                      case 'yenikonu':
                        if(isset($_POST['yeniyaziekle'])){
                            ...
                            if(!$baslik || !$kategori || !$icerik || !$etiketler){
                                ...
                                ## etiketler isef linke çevirmek için yazıldı...
                                ...
                                if($image->uploaded){
                                    ...
                                    if($image->processed){
                                        ...
                                        if($konuekle->rowCount()){
                                            $gonderen = "osmantlyhn7334@gmail.com";
                                            $parola = "zeynep2017";
                                            $mail = new PHPMailer();
                                            $mail->Host = "smtp.yandex.com"; ## mail hangi sunucuda barınıyorsa oranın host namei
                                            ...
                                            $mail->IsSMTP();
                                            $mail->From = $gonderen;
                                            $mail->FromName = "Osman Talayhan Blog |Yeni konu eklendi!";
                                            $mail->CharSet = "UTF-8";
                                            ...
                                            $mailicerik = "Konu Başlığı : " . $konurow->yazi_baslik . "<br> Konu Linki : " . $arow->site_url ."/yazidetay.php?yazi_sef=" . $konurow->yazi_sef."&id=".$konurow->yazi_id;
                                            $mail->MsgHTML($mailicerik);
                                            if($mail->Send()){
                                                echo "<script>alert('Konu başarıyla eklendi. Abonelere mail gönderildi.');</script>";
                                            }else{
                                                echo "<script>alert('Mail gönderilmedi!');</script>";
                                            }
                                        }else{
